...
| System integration with Rover Controller | Wireless module can communicate with rover controller | Commands and telmetry reliably exchanged without data loss | No |
